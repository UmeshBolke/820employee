...
function Login() {
    ...
    const login = (e) => {
        ...
        axios.post("https://employee-crud-dbr4.onrender.com/login", { email: loginForm.email, password: loginForm.password })
            .then((response) => {
                if (response.data) {
                navigate("/allemp")
            ...
            <main className="flex-1 flex items-center justify-center px-6 ">
                <div className="bg-white/95  shadow-lg rounded-lg p-8">
                    ...
                    <form onSubmit={login} className="space-y-6  p-6 m-3">
                        ...
                        <p>If you are new please register,<a href='/register' className='text-blue-800 font-medium px-1 py-2 rounded-md transition  hover:text-green-700  '>Register</a></p>
