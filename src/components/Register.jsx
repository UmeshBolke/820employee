...
function Register() {
  ...
  const register = async (e) => {
    ...
    try {
      const response = await axios.post("https://employee-crud-dbr4.onrender.com/register", {
          ...
          <div className="bg-white/95 shadow-lg rounded-lg p-8">
            ...
            <form onSubmit={register} className="space-y-4">
              ...
              <p>
                ...
                <Link to={"/login"} className='text-blue-800 font-bold px-1 py-2 rounded-md transition  hover:text-green-700  '>Login</a>
              </p>
